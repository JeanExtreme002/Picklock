...
def test_examples_and_the_prompt_share_one_shade(capture, shell):
    """Both mean the same thing — context around the output, not output."""
    capture.printer.color = True
    shell.run_line("scan:help")
    transcript = next(
